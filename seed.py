...
Crée les tables et insère du contenu d'exemple (à remplacer plus tard
par les vraies informations de la famille).
...
with app.app_context():
    ...
    if FamilyMember.query.count() == 0:
        ...
        db.session.flush()  # pour récupérer grand_pere.id
    ...
    db.session.commit()
    print("Base de données initialisée avec du contenu d'exemple.")
